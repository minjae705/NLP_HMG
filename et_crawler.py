...
driver.find_element_by_name('userid').send_keys('minjae8523')
driver.find_element_by_name('password').send_keys('alswo3974')
...
while True:
    ...
    if cnt > 100: # 나중에 10,000 개로 수정
        break
        
    cnt = cnt + 1
    driver.get('https://everytime.kr/374399/p/'+ str(cnt))
    driver.implicitly_wait(1)
